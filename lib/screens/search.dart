          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Obx(
                  () => controller.searchedBooks.isEmpty || _inputText!.isEmpty
                      ? Center(
                          child: Text(
                            ...
                            children: [
                              GridView.custom(
                                ...
                                childrenDelegate: SliverChildBuilderDelegate(
                                  ...
                                  return BookTile(
                                    height: 200,
                                    width: (200 * tile.aspectRatio)
                                        .ceil()
                                        .toDouble(),
                                    title:
                                        controller.searchedBooks[index].title,
                                    image:
                                        controller.searchedBooks[index].image,
                                    onTap: () =>
                                        Navigator.of(context).pushNamed(
                                      '/detail-book',
                                      arguments: controller
                                          .searchedBooks[index].isbn13,
                                    ),
                                  );
